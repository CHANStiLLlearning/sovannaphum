...
import { LayoutDashboard, Newspaper, Briefcase, Mail, Users, LogOut } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <aside className="w-full md:w-64 bg-[#9A2220] text-white flex flex-col shadow-xl z-10">
        <div className="p-6 border-b border-white/10">
          <h2 className="text-2xl font-extrabold tracking-tight">SPS Admin</h2>
